        ...
        extras: [
          {
            ...
            items: [
              ...
              { term: '"Eudremia"', def: 'Es el término para el pH sanguíneo arterial normal: 7.35 a 7.45. Fuera de ese rango hacia abajo es acidemia (sangre muy ácida); hacia arriba, alcalemia (sangre muy alcalina). Este equilibrio es esencial para el funcionamiento celular, pulmonar y renal.' }
            ]
          },
          {
            tipo: 'tarea',
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        cuerpo: `
          <p><strong>AGA:</strong> pH 7.42 (normal — eudremia), PCO2 39.6 (normal), bicarbonato 25 (normal), saturación 95.3%, PO2 81.3.</p>
          <div class="scale-box">
            <table class="scale-table">
